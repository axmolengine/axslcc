                       ...
                       bool separateSamplerBindings)
{
    ...
    if (spirv)
    {
        ...
        {
            // Shift samplers away from texture slots in both set 1 (presets) and set 2 (custom).
            // Presets: set1, binding=1024+presetIndex. Custom: set2, binding=1024+localIndex.
            push(L"-fvk-s-shift");
            push(L"1024");
            push(L"all");
        }
